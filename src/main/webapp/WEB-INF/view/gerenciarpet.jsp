               ...
               <div class="col-sm-12 col-md-3 col-lg-3">
                  ...
                  <div class="dashboard_tab_button">
                     <ul role="tablist" class="nav flex-column dashboard-list">
                        <li><a href="#" class="nav-link btn btn-sm btn-default-outline  active">Gerenciar pet</a></li>
                        <li><a href="/pet/minhaconta#cadastrar" class="nav-link btn btn-sm btn-default-outline ">Cadastrar Pets</a></li>
                  ...
                  <div class="tab-content dashboard_content">
                     <div class="tab-pane fade show active" id="inicio">
                                                ...
                                                <tr>
                                                                           ...
                                                                           <tbody>
                                                                              <c:forEach var="pet" items="${gerenciarpet}">
                                                                                 <tr>
                                                                                    <td>${pet.id}</td>
                                                                                    <td>${pet.nome}</td>
                                                                                    <td>${pet.raca}</td>
                                                                                    <td>${pet.idade}</td>
                                                                                    <td>
                                                                                       <a href="/pet/${pet.id}"><button class="pet-card-button" type="submit">Editar</button></a>
